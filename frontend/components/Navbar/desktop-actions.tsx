...
export default function DesktopActions() {
  return (
    <div className="hidden lg:flex items-center space-x-4">
      ...
      <Link href={'/pricing'} className="relative group px-8 py-4 bg-white text-black font-bold rounded-2xl overflow-hidden shadow-2xl hover:shadow-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-1">
